    ...
    <div class="col-md-3 col-xs-12 col-sm-6 dock side" style="z-index: 9999; ">
        <div class="dock-inner">
            <header class="dock-header">
                <h3>
                    <span>我的Luban</span>
                    <span class="icon-circle-arrow-right smaller dock-close-btn"></span>
                </h3>
            </header>
            <div class="dock-body">
                <div class="dock-content">
                    <div class="dock-item" style="padding: 20px;" v-if="loginstaus==0">
                    ...
                    <div class="dock-item active" style="padding: 20px;" v-if="loginstaus==1">
                    ...
                    <div class="profile" v-if="loginstaus==2">
                        <div class="profile-inner">
                            <div class="profile-content ">
                                <div id="profile-info" class="profile-panel active" style="margin-top: 80px;text-align: center">
                                    <div class="profile-face" style="margin-bottom: 25px;">
                                        <img id="profile-face-img" alt="" src="/assets/images/face_150.png">
                                    </div>
                                    <h4>欢迎您：Linzuxin</h4>
                                    <p>位置：福建 - 福州</p>
                                </div>
                                <div id="profile-face-upload" class="profile-panel">
                                    <div class="profile-face" style="margin-bottom: 15px;">
                            ...
                            <div class="profile-footer row">
                                <!-- 
                                <div id="profile-edit-action" class="col-md-4 col-sm-4 col-xs-4 profile-action">
                                    <a href="#" style="text-decoration: none"><span class="glyphicon glyphicon-edit"></span>
                                        <br />个人信息
                                    </a>
                                </div>
                                -->
                                <div id="profile-lock-action" class="col-md-6 col-sm-6 col-xs-6 profile-action">
                                    <a href="#" >
                                        <span class="icon-unchecked"></span>
                                        <br>锁定屏幕
                                    </a>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 profile-action">
		...
		$.ajax({
			...
			success : function(data){
				if(data.success){
					...
					$("#login-alert").hide();
					$(".dock-content").find(".active").removeClass("active").fadeOut();
