        ...
        <div class="modal-content" modal-transclude="">
            <div class="ng-scope">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">学员课耗明细</h3></div>
                <div class="modal-body">
                    <!-- ngIf: vm.input.lesson_type == '0' -->
                    <div xo-rest="student_hours" xo-rest-grid="{maxsize:5,params:{pagesize:50,page:1,ocs_id:vm.input.ocs_id}}" ng-if="vm.input.lesson_type == '0'" class="ng-scope">
                            ...
                            <table class="table table-striped b-t b-light">
                                ...
                                <tbody>
                                    ...
                                    <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                                        ...
                                        <td class="ng-binding">05-12 11:00 <span class="bg-info label ng-binding">周五</span>
                                            <br><span class="badge bg-success ng-binding">1.00小时</span></td>
                                        <td class="ng-binding">班课
                                            <br><span class="label bg-info ng-binding">3期班</span></td>
                                        <td class="ng-binding">陈佳木
                                            <br><span class="label bg-info ng-binding">￥0.00</span></td>
                                        <td class="ng-binding">2017-05-12 09:05
                                            <br>陈佳木</td>
                                    </tr>
                                    <!-- end ngIf: !loading -->
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-4 col-xs-12">课程金额总计:<span class="label bg-info ng-binding">￥0.00</span>,小计:<span class="label bg-info ng-binding">￥0</span></div>
                    ...
                    <!-- end ngIf: vm.input.lesson_type == '0' -->
                    <!--1对1-->
                    <!-- ngIf: vm.input.lesson_type == '1' -->
                    <!--课时包-->
                    <!-- ngIf: vm.input.lesson_type == '10' -->
                </div>
            </div>
        </div>
    </div>
