                    ...
                    <div class="ng-scope">
                        ...
                        <div class="wrapper bg-light b-a m-t-xs">
                            ...
                            <div class="row no-gutter m-t">
                                <div class="col-xs-5">
                                    <button ng-click="$util.open('tpl/app/student/order/pay_now.modal.html','md',order)" @click="lbShowdialog($event,'lb-paynowmodal')">
                                        <i class="icon-wallet"></i>现场缴费
                                    </button>
                                </div>
                                <div class="col-xs-4 ng-scope" ng-if="order.order_amount > 0">
                                    <button ng-click="$util.open('tpl/app/student/order/pay_reg.modal.html','md',order)" @click="lbShowdialog($event,'lb-payregmodal')">
