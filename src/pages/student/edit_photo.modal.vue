            ...
            <div page-controller="photo" class="ng-scope">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">
                        ...
                        <span class="badge bg-info ng-binding">{{lb_localdata.form.student_name }}</span>的图像
                    </h3>
                </div>
                        ...
                        <div class="col">
                            ...
                            <div class="inline bg-white wrapper-sm b-a">
                                <div class="bg-light img-circle">
                                    <img :src="imageData" class="img-circle">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    methods: {
        ...
        handleChange(file) {
            ...
            reader.onload = function(e) {
                ...
                if (vm.cropper) {
                    vm.cropper.replace(e.target.result)
                } else {
                    let imageSize = {
                        width: 160,
                        height: 160
                    ...
                    vm.cropper = new Cropper(image, {
                        aspectRatio: 1 / 1,
                        ready: function() {
                            let result = vm.cropper.getCroppedCanvas(imageSize)
                            vm.imageData = result.toDataURL('image/jpg')
                        },
                        cropend: function() {
                            let result = vm.cropper.getCroppedCanvas(imageSize)
                            vm.imageData = result.toDataURL('image/jpg')
