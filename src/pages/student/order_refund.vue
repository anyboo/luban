        ...
        <div class="modal-content" modal-transclude="">
            ...
            <div ng-init="init_pays()" ng-controller="OrderRefundCtrl" class="ng-scope">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><i class="icon-note"></i>为订单号 <span class="label bg-info ng-binding">OB1161217170444033750849</span> 办理退款</h3></div>
                        ...
                        <form name="form1" class="form-horizontal for-validation ng-pristine ng-valid" novalidate="">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-md-5">
                                    <p class="form-control-static ng-binding">李哥</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-md-2">订单号:</label>
                                <div class="col-xs-12 col-md-5">
                                    <p class="form-control-static ng-binding">OB1161217170444033750849</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-md-2">订单内容:</label>
                                <div class="col-xs-12 col-md-5">
                                    <p class="form-control-static ng-binding">班课[1班]20次
                                        <!-- ngIf: oph.remain_times > -1 --><span class="text-danger ng-binding ng-scope" ng-if="oph.remain_times > -1">剩余 20 次</span>
                                        <!-- end ngIf: oph.remain_times > -1 -->
                                        <!-- ngIf: vm.input.present_times > 0 -->
                                    </p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-md-5">
                                    <p class="form-control-static ng-binding">270.00元</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-md-2">缴费金额:</label>
                                <div class="col-xs-12 col-md-5">
                                    <p class="form-control-static ng-binding">200.00元</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-md-2">缴费方式:</label>
                                <div class="col-xs-12 col-md-5">
                                    <p class="form-control-static ng-binding">微信支付
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-md-5">
                                    <p class="form-control-static ng-binding">2017-04-17 15:38</p>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <!-- ngIf: oph.money_pay_amount > 0 && vm.input.order_type != '2' -->
                            ...
                            <!-- end ngIf: oph.money_pay_amount > 0 && vm.input.order_type != '2' -->
                            <!-- ngIf: oph.balance_pay_amount > 0 -->
                            ...
                            <div class="form-group ng-scope" ng-if="order.order_type == '0' || order.order_type == '1' || order.order_type == '10'">
                                ...
                                <div class="col-xs-12 col-md-9">
                                    ...
                                    <!-- ngIf: refund.refund_times_policy == 1 -->
                                </div>
                            </div>
