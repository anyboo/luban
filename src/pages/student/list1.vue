    ...
    <div class="wrapper bg-white ng-scope" page-controller="list1index">
        <div class="row no-gutter">
            <div class="col-xs-12 col-md-3">
                <div class="btn-group">
                    <label btn-radio="0" ng-model="lesson_type" class="btn btn-default ng-untouched ng-valid ng-dirty active ng-valid-parse">班课学员</label>
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            ...
                            <td>
                                ...
                                <!-- ngIf: item.pay_status == '1' --><span class="label bg-warning ng-binding ng-scope" ng-if="item.pay_status == '1'">欠费:￥22.00</span>
                                <!-- end ngIf: item.pay_status == '1' -->
                                <!-- ngIf: item.pay_status == '0' -->
                            </td>
                            <td class="ng-binding">4</td>
                            <td><span class="badge bg-info ng-binding">￥16.50</span></td>
                            <td class="ng-binding">3 <a class="btn btn-default btn-xs" ng-click="$util.open('tpl/app/student/view_course.modal.html','lg',{ocs_id:item.ocs_id,lesson_type:'0'})"><i class="icon-eye"></i></a></td>
                            <td><span class="badge bg-info ng-binding">￥49.5</span></td>
