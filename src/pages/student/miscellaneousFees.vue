        ...
        <div ng-include="'tpl/app/student/order/'+$action+'.html'" class="ng-scope">
            <div ng-controller="OrderCreateOtherCtrl" class="ng-scope">
                ...
                <div class="row no-gutter b-t m-t">
                    ...
                    <div class="col-xs-4">
                        <button type="button" class="btn btn-warning btn-block" ng-disabled="saving" ng-click="back_menu()" @click="handleOpena($event)"><i class="fa fa-reply"></i> 返回</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        handleOpena(event) {
            ...
            if (this.$parent && this.$parent.handleOpena) {
                clearTimeout(this.timeCloseId)
                this.$parent.handleOpena()
            }
