            ...
            <div ng-include="'tpl/app/student/order/'+$action+'.html'" class="ng-scope">
                <div ng-controller="OrderCreate1by1Ctrl" class="ng-scope">
                        ...
                        <div class="form-group m-t">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-10">
                                <div class="input-group">
                                    <input type="text" placeholder="课程" ng-model="selected_lesson_name" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" ng-readonly="true" required="" readonly="readonly"> <span class="input-group-btn"><button class="btn btn-default" select-tpl="tpl/directive/selectLessonTpl.html" select-id-field="ol_id" max-num="1" on-selected="select_lesson" select-params="{lesson_type:1}" select-title="请选择课程"><i class="fa fa-book"></i>选择课程</button></span></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">报名课次:</label>
                    ...
                    <div class="row no-gutter b-t m-t">
                        ...
                        <div class="col-xs-4">
                            <button type="button" class="btn btn-warning btn-block" ng-disabled="saving" ng-click="back_menu()" @click="handleOpent($event)"><i class="fa fa-reply"></i> 返回</button>
                        </div>
                    </div>
                </div>
            </div>
