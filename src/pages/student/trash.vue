    ...
    <div class="modal-dialog" ng-class="{'modal-sm': size == 'sm', 'modal-lg': size == 'lg','modal-full':size == 'full'}">
        <div class="modal-content" modal-transclude="">
            <div class="modal-header ng-scope">
                ...
                <h3 class="modal-title"><i class="icon-lock"></i>已封存学员档案列表</h3></div>
            <div class="wrapper bg-white ng-scope" xo-rest="students" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,isdelete:1}}" xo-rest-ctrl="trash">
                        ...
                        <table class="table table-striped b-t b-light">
                            ...
                            <tbody>
                                ...
                                <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                                    <td class="ng-binding"><span ng-bind-html="item.sex|sex:0" class="ng-binding"><i class="fa fa-male"></i></span>照理</td>
                                    <td class="ng-binding">12368454877</td>
                                    <td class="ng-binding">2017-05-13</td>
                                    <td><a class="link" ng-click="do_recover(item)"><i class="icon-lock-open"></i>恢复</a> <a class="link" ng-click="confirm_delete(item)" ui-per="student.delete"><i class="fa fa-times"></i>删除</a></td>
                                </tr>
                                <!-- end ngIf: !loading -->
                ...
                <!-- end ngIf: $action == 'list' -->
                <!-- ngIf: $action == 'confirm_delete' -->
            </div>
        </div>
    </div>
</template>
