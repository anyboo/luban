<template>
    <div class="modal-dialog" ng-class="{'modal-sm': size == 'sm', 'modal-lg': size == 'lg','modal-full':size == 'full'}">
        <div class="modal-content" modal-transclude>
            ...
            <div class="modal-body ng-scope" ng-controller="OrderPayNowCtrl">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="input-group">
                                    <input type="number" class="form-control ng-pristine ng-untouched ng-valid ng-valid-b ng-valid-a" name="money_pay_amount" ui-validate="{ a:'$value >= 0', b:'$value <= order_unpay_amount' }" v-model="localdata.form.lb_pay_money_pay_amount">
