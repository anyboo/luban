    ...
    <div class="modal-dialog" ng-class="{'modal-sm': size == 'sm', 'modal-lg': size == 'lg','modal-full':size == 'full'}">
        <div class="modal-content" modal-transclude="">
            ...
            <div class="modal-header ng-scope">
                ...
                <h3 class="modal-title"><i class="icon-wallet"></i>为订单号 <span class="label bg-info ng-binding">OC1161217130540023908405</span> 缴费</h3></div>
                    ...
                    <form name="form1" class="form-horizontal form-validation ng-pristine ng-valid ng-valid-b ng-valid-a" novalidate="">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-5">
                                <p class="form-control-static ng-binding">威锋
