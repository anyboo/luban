                            ...
                            <div class="col-xs-12 col-md-3">
                                <div class="input-group ng-valid" ng-model="pay.op_name" select-title="请选择经办人" select-params="{ob_id:user.gv.ob_id}">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default " select-tpl="tpl/directive/selectTeacherTpl.html" select-id-field="oe_id" select-title="请选择经办人" on-selected="set_user" select-params="selectParams" @click="lbShowDailog('lb-selectteachertpl')">
