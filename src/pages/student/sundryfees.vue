                        ...
                        <form name="form1" class="form-horizontal ng-pristine ng-valid ng-valid-required">
                            <div class="form-group m-t">
                                ...
                                <div class="col-xs-12 col-sm-9 col-md-10">
                                    <div class="w-sm">
                                        <select class="form-control ng-pristine ng-untouched ng-valid ng-valid-required" ui-jq="chosen" ng-options="item.odi_id as item.text for item in $gv.dicts[5]" required style="display: none;" v-model="localdata.form.order_odi_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-md-5">
                                    <div class="input-group">
                                        <input type="number" name="origin_amount" ng-change="order.order_amount = order.origin_amount" class="form-control ng-pristine ng-untouched ng-valid ng-valid-required" required v-model="localdata.form.order_origin_amount">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-md-10">
                                    <input type="text" class="form-control ng-pristine ng-untouched ng-valid" name="order_remark" ng-disabled="order.oc_id == 0" placeholder="如有备注请输入" v-model="localdata.form.order_order_remark">
                                </div>
                            </div>
                            <div class="form-group">
