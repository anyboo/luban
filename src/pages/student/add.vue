        ...
        <div class="wrapper ng-scope" page-controller="student_add">
            <form name="form1" novalidate="" class="form form-horizontal form-validation ng-pristine ng-invalid ng-invalid-required ng-valid-pattern" ng-submit="do_save()">
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="fa fa-user"></i>学员档案录入 <a class="btn btn-default btn-xs" ng-click="$util.open('tpl/app/student/import.html','md',{})"><i class="glyphicon glyphicon-import"></i> 从Excel导入</a></div>
                    ...
                    <div class="m-t m-b panel-footer">
                        <div class="form-group">
                            <div class="col-xs-12 col-md-10 col-md-offset-2">
                                <button type="submit" class="btn btn-primary w" ng-disabled="form1.$invalid || form_invalid() || saving" disabled="disabled">
                                    <!-- ngIf: saving -->确认</button>
                            </div>
                        </div>
                    </div>
                </div>
