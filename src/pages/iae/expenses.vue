        ...
        <div class="panel panel-default ng-scope" xo-rest="expenses" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,ob_id:user.gv.ob_id}}" xo-rest-ctrl="expenses">
            <div class="row wrapper">
                ...
                <div class="col-xs-12 col-md-8 m-t">
                    ...
                    <button class="btn btn-default ng-isolate-scope" export="expenses" export-params="params"><i class="glyphicon glyphicon-export"></i>导出</button>
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            ...
                            <td><span class="badge bg-danger ng-binding">-30.00</span></td>
                        ...
                        <tr ng-if="grid.$data.ctotal_amount" class="ng-scope">
                            <td></td>
                            <td colspan="4">小计:<span class="text-danger ng-binding">-30元</span></td>
                        </tr>
