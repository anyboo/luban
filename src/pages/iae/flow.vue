        ...
        <div class="panel panel-default ng-scope" xo-rest="fees" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,ob_id:user.gv.ob_id}}" xo-rest-ctrl="fees">
            <div class="row wrapper">
                ...
                <div class="col-xs-12 col-md-8 m-t">
                    ...
                    <a ng-click="$util.open('tpl/app/iae/flow.add.modal.html','md',{})" @click="lbShowDailog($event,'lb-flowaddmodal')">
                    ...
                    <tbody>
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            <td>
                                ...
                                <a ng-click="$util.open('tpl/app/iae/set_odi.modal.html','sm',item)" @click="lbShowDailog($event,'lb-setodimodal')">设置分类</a>
                            </td>
