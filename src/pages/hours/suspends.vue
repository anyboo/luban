        ...
        <div class="panel panel-default ng-scope" xo-rest="suspends" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,ob_id:user.gv.ob_id}}" xo-rest-ctrl="suspends">
            <div class="row wrapper">
                ...
                <div class="col-xs-12 col-md-6 m-t">
                    ...
                    <button class="btn btn-primary pull-right" select-tpl="tpl/directive/selectStudentTpl.html" select-id-field="os_id" max-num="1" on-selected="student_suspend" select-params="{ob_id:user.gv.ob_id}" select-title="请选择学员进行停课登记"><i class="icon-plus"></i> 停课登记</button>
                </div>
            </div>
            <!--row-->
