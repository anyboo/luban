        ...
        <div class="panel panel-default ng-scope" xo-rest="leaves" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,ob_id:user.gv.ob_id}}" xo-rest-ctrl="leaves">
            <div class="row wrapper">
                <div class="col-xs-12 col-md-6 m-t">
                    <!-- ngIf: !show_time_filter --><a class="link ng-scope" ng-if="!show_time_filter" ng-click="show_filter()"><i class="glyphicon glyphicon-calendar"></i> 按时间过滤</a>
                    <!-- end ngIf: !show_time_filter -->
                    <!-- ngIf: show_time_filter -->
                </div>
                <div class="col-xs-12 col-md-6 m-t">
                    ...
                    <button class="btn btn-default ng-isolate-scope" export="leaves" export-params="params"><i class="glyphicon glyphicon-export"></i>导出</button>
                    ...
                    <div class="btn-group dropdown pull-right" dropdown="">
                        <button class="btn btn-success" dropdown-toggle="" aria-haspopup="true" aria-expanded="false"><i class="icon-plus"></i> 请假登记 <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a select-tpl="tpl/directive/selectStudentTpl.html" select-id-field="os_id" max-num="1" on-selected="student_leave" select-params="{ob_id:user.gv.ob_id}" select-title="请选择学员进行请假登记"><i class="fa fa-plus"></i> 按上课时间单次登记</a></li>
                            <li><a select-tpl="tpl/directive/selectStudentTpl.html" select-id-field="os_id" max-num="1" on-selected="student_arrange_leave" select-params="{ob_id:user.gv.ob_id}" select-title="请选择学员按排课登记考勤"><i class="fa fa-calendar"></i> 按排课记录批量登记</a></li>
                            <li><a select-tpl="tpl/directive/selectSClassTpl.html" select-id-field="osc_id" max-num="1" on-selected="sclass_arrange_leave" select-params="{ob_id:user.gv.ob_id}" select-title="请选择科目班级登记考勤"><i class="fa fa-users"></i> 按科目班级批量登记</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-striped table-hover b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            <td class="ng-binding"><span ng-bind-html="item.student.sex|sex:0" class="ng-binding"><i class="fa fa-male"></i></span> 李哥
                                <p><a class="btn btn-danger btn-xs ng-isolate-scope" confirm-text="确认要删除该请假信息吗?" confirm-action="remove_leave(item)"><i class="icon-ban" ng-disabled="saving"></i>删除</a></p>
                            </td>
                            <td>
                                <ul class="list-unstyled w4">
                                    <li class="ng-binding">
                                        <label>上课日期:</label>2017-05-19</li>
                                    <li>
                                        <label>上课时间:</label><span class="ng-binding">11:00</span> - <span class="ng-binding">12:00</span></li>
                                    <li class="ng-binding">
                                        <label>请假原因:</label>病假</li>
                                </ul>
                            </td>
                            <td>
                                <!-- ngIf: item.ota_id > 0 -->
                                <ul class="list-unstyled w6 ng-scope" ng-if="item.ota_id > 0">
                                    <li>
                                        <label>课程/班级:</label><span class="ng-binding">3期班</span></li>
                                    <li>
                                        <label>授课老师:</label><span class="ng-binding">陈佳木</span></li>
                                </ul>
                                <!-- end ngIf: item.ota_id > 0 -->
                                <!-- ngIf: item.ota_id == 0 -->
                            </td>
                            <td class="ng-binding">2017-05-12 15:59
                                <br>
                                <!-- ngIf: item.create_from == 0 --><span class="label bg-warning ng-scope" ng-if="item.create_from == 0">机构登记</span>
                                <!-- end ngIf: item.create_from == 0 -->
                                <!-- ngIf: item.create_from == 1 -->
                            </td>
                        </tr>
                        <!-- end ngIf: !loading -->
