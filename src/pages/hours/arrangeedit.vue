                            ...
                            <div class="col-sm-9" style="width: 463px;border: 1px solid rgba(12,12,12,.12);height:70px;position:relative;left:15px;">
                                <div class="form-group col-sm-12" style="padding-top: 0;margin-bottom: 0;margin-top:5px;">
                                    <div class="weekWidth" style="float:left">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" v-model="localdata.form.day_1" @click="daychange"><span>星期一</span></label>
                                    </div>
                                    <div class=" weekWidth" style="float:left">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" v-model="localdata.form.day_2" @click="daychange"><span>星期二</span></label>
                                    </div>
                                    <div class=" weekWidth" style="float:left">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" v-model="localdata.form.day_3" @click="daychange"><span>星期三</span></label>
                                    </div>
                                    <div class="weekWidth" style="float:left">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" v-model="localdata.form.day_4" @click="daychange"><span>星期四</span></label>
                                    </div>
                                    <div class=" weekWidth">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" v-model="localdata.form.day_5" @click="daychange"><span>星期五</span></label>
                                    </div>
                                    <div class=" weekWidth helpchoose" style="float:right;position:relative;top:-28px;display:1px solid #ddd;">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" @click="workchange" v-model="workday"><span>工作日</span></label>
                                    </div>
                                </div>
                                <div class="form-group col-sm-12" style="margin-top: 5px;padding-top: 0;margin-bottom: 0;">
                                    <div class="weekWidth helpchoose" style="float:right;position:relative;top:-32px;left:-13px;">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" @click="workchange" v-model="weekday"><span>周末</span></label>
                                    </div>
                                    <div class=" weekWidth" style="float:left;position:relative;top:-28px ">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" @click="daychange" v-model="localdata.form.day_6"><span>星期六</span></label>
                                    </div>
                                    <div class=" weekWidth" style="float:left;position:relative;top:-28px">
                                        <label class="checkbox-inline checkbox-styled">
                                            <input type="checkbox" @click="daychange" v-model="localdata.form.day_7"><span>星期日</span></label>
                                    </div>
                                </div>
                            </div>
                        </div>
