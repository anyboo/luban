        ...
        <div class="panel panel-default ng-scope" xo-rest="attendances" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,ob_id:user.gv.ob_id}}" xo-rest-ctrl="attendances">
            <div class="row wrapper">
                ...
                <div class="col-xs-12 col-md-8 m-t">
                    ...
                    <button class="btn btn-primary pull-right" ui-per="widget.attendance" ng-click="$util.open('tpl/app/widget/attendance.modal.html','lg',{})"><i class="icon-plus"></i> 考勤登记</button>
                </div>
            </div>
            <!--row-->
                ...
                <table class="table table-striped table-hover b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            <td class="ng-binding"><span ng-bind-html="item.student.sex|sex:0" class="ng-binding"><i class="fa fa-male"></i></span> 李达康</td>
                            <td class="ng-binding">古典吉他初级</td>
                            <td class="ng-binding">陈佳木</td>
                            <td class="ng-binding">05-12 11:00</td>
                            <td>
                                <!-- ngIf: item.is_in == '1' --><span class="label bg-success ng-scope" ng-if="item.is_in == '1'">正常出勤</span>
                                <!-- end ngIf: item.is_in == '1' -->
                                <!-- ngIf: item.is_in == '0' -->
                            </td>
                            <td>
                                <!-- ngIf: item.att_way == '0' --><span class="label bg-info ng-scope" ng-if="item.att_way == '0'">后台登记</span>
                                <!-- end ngIf: item.att_way == '0' -->
                                <!-- ngIf: item.att_way == '1' -->
                            </td>
                        ...
                        <!-- ngIf: !loading -->
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            <td class="ng-binding"><span ng-bind-html="item.student.sex|sex:0" class="ng-binding"><i class="fa fa-female"></i></span> 小兵</td>
