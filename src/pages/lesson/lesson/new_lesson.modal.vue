        ...
        <div class="modal-content" modal-transclude="">
            <div page-controller="new_lesson" class="ng-scope">
                ...
                <div class="modal-body">
                    <form name="form1" class="form-validation form-horizontal ng-invalid ng-invalid-required ng-valid-minlength ng-valid-pattern ng-dirty ng-valid-parse">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <div class="btn-group">
                                            <label btn-radio="'0'" ng-model="lesson.lesson_type" class="btn btn-default ng-untouched ng-valid active ng-dirty ng-valid-parse">班课</label>
                                            <label btn-radio="'1'" ng-model="lesson.lesson_type" class="btn btn-default ng-untouched ng-valid ng-dirty">1对1</label>
                                            <label btn-radio="'10'" ng-model="lesson.lesson_type" class="btn btn-default ng-untouched ng-valid ng-dirty">课时包</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
