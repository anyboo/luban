            ...
            <div class="panel panel-default">
                <div class="row wrapper">
                    ...
                    <div class="col-xs-12 col-md-8">
                        ...
                        <div class="btn-group m-l">
                            ...
                            <label btn-radio="'10'" ng-model="params.lesson_type" class="btn btn-default ng-pristine ng-untouched ng-valid">时包课</label>
                        </div>
                        <button class="btn btn-default pull-right" ng-click="$util.open('tpl/app/lesson/lesson/cate.html','lg',{})" @click="lbShowdialog($event,'lb-cate')"><i class="fa fa-list"></i> 课程分类</button>
                        <button ui-per="lesson.add" class="btn btn-primary pull-right" ng-click="$util.open('tpl/app/lesson/lesson/new_lesson.modal.html','md',{})" @click="lbShowdialog($event,'lb-newlessonmodal')"><i class="fa fa-plus"></i>添加课程</button>
                    </div>
                </div>
                    ...
                    <table class="table table-hover b-t b-light">
                        ...
                        <tbody>
                            <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                                ...
                                <td>
                                    <p class="ng-binding">
                                        <span class="label bg-danger ng-binding ng-scope" ng-if="item.lesson_type=='0'">班课</span> 默认课程嗯嗯 <small class="label bg-info m-l ng-binding">DL1</small></p>
                                </td>
                                <td>
                                    <p class="ng-binding">
                                    ...
                                    <p>
                                        <label>课程售价:</label><span class="label bg-info ng-binding" ng-bind="item.price">0.12</span>元</p>
                                </td>
                                <td>
                                    <p>
                                    ...
                                    <p>
                                        <label>课程包含:</label>
                                        <span class="label bg-info ng-binding ng-scope" ng-if="item.price_model=='0'">111期,</span>
                                        <span class="label bg-info ng-binding" ng-bind="item.inc_hours|empty_replace">1012.11</span>课时</p>
                                </td>
                                <td>
                                    <p><span ng-bind-html="item|branchs" class="ng-binding"><label class="xlabel">呵呵</label></span></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-center"><small class="text-muted inline m-t-sm m-b-sm ng-binding" ng-bind-template="共 10 门课程">共 10 门课程</small></div>
