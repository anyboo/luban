            ...
            <div class="panel panel-default">
                ...
                <div class="table-responsive">
                    ...
                    <div class="grid-data-result">
                        ...
                        <p class="text-center ng-binding ng-scope" ng-if="!loading &amp;&amp; grid.data.length==0"><i class="fa fa-frown-o"></i>没有符合条件的1对1合同!</p>
                ...
                <div class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-center"><small class="text-muted inline m-t-sm m-b-sm ng-binding" ng-bind-template="共 0 份合同">共 0 份合同</small></div>
