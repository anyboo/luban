        ...
        <div class="modal-content" modal-transclude="">
            <div page-controller="edit_lesson" class="ng-scope">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><i class="icon-briefcase"></i> 编辑课程</h3></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <p class="form-control-static">
                                            <!-- ngIf: lesson.lesson_type=='0' --><span class="label bg-danger ng-binding ng-scope" ng-if="lesson.lesson_type=='0'">班课</span>
                                            <!-- end ngIf: lesson.lesson_type=='0' -->
                                            <!-- ngIf: lesson.lesson_type == '1' -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 col-xs-12">
                                        ...
                                        <div class="input-group ng-scope" ng-if="lesson.price_model=='1'">
                                            <input type="text" name="inc_times" ng-pattern="/^[0-9]+$/" ng-model="lesson.inc_times" ng-change="cacu_price()" class="form-control ng-pristine ng-untouched ng-valid ng-valid-pattern ng-valid-parse"> <span class="input-group-addon">次</span></div>
                                        <!-- end ngIf: lesson.price_model=='1' -->
                                    </div>
                                </div>
                                <div class="form-group">
