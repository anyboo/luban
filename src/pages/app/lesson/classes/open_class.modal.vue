                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-xs-12">
                                <div class="input-group">
                                    <input type="text" name="master" ng-model="info.master" class="form-control ng-pristine ng-valid ng-touched" readonly="true"> <span class="input-group-btn"><button class="btn btn-default" select-tpl="tpl/directive/selectTeacherTpl.html" select-id-field="oe_id" select-title="请选择老师" on-selected="select_teacher" select-params="{ob_id:user.gv.ob_id,role_id:2}"><i class="fa fa-user"></i> 选择</button></span></div>
                            </div>
                        </div>
                        <div class="form-group">
