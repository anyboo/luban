    ...
    <div class="modal-dialog" ng-class="{'modal-sm': size == 'sm', 'modal-lg': size == 'lg','modal-full':size == 'full'}">
        <div class="modal-content" modal-transclude="">
            ...
            <div class="modal-header ng-scope">
                ...
                <h3 class="modal-title"><i class="icon-note"></i>为订单号 <span class="label bg-info ng-binding">OB1167817130555041543344</span> 登记缴费记录</h3></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-3">
                                <div class="input-group">
                                    <input type="number" class="form-control ng-pristine ng-untouched ng-valid" name="pay_amount" ng-model="pay.pay_amount"> <span class="input-group-addon">元</span></div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-10">
                                ...
                                <div class="chosen-container chosen-container-single" style="width: 90px;" title=""><a class="chosen-single" tabindex="-1"><span>现金</span><div><b></b></div></a>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-3">
                                <div class="input-group  ng-valid" ng-model="pay.op_name" select-title="请选择经办人" select-params="{ob_id:user.gv.ob_id}">
                                    <input type="text" name="name" ng-model="name" class="form-control ng-pristine ng-untouched ng-valid" ng-readonly="valueField != 'name'"> <span class="input-group-btn"><button class="btn btn-default " select-tpl="tpl/directive/selectTeacherTpl.html" select-id-field="oe_id" select-title="请选择经办人" on-selected="set_user" select-params="selectParams"><i class="fa fa-user"></i></button></span></div>
                            </div>
                        </div>
                        <div class="form-group m-t">
                            <div class="col-xs-12 col-md-offset-2">
                                <button class="btn btn-primary" ng-click="do_reg()" ng-disabled="saving">
                                    <!-- ngIf: saving -->确认登记</button>
