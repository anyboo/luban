            ...
            <div ng-controller="wAttendanceCtrl" class="ng-scope">
                ...
                <div class="modal-body" ng-switch="$action">
                    ...
                    <div ng-switch-when="menu" class="ng-scope">
                        <ul class="list-group">
                            <li class="list-group-item" ng-click="att_by_today()" ui-per="widget.now_attendance"><i class="fa fa-chevron-right"></i>
                            ...
                            <li class="list-group-item" ng-click="att_by_reg()"><i class="fa fa-chevron-right"></i>
                            ...
                            <li class="list-group-item" ng-click="att_by_student()"><i class="fa fa-chevron-right"></i>
