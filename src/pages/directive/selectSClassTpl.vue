    ...
    <div class="modal-dialog" ng-class="{'modal-sm': size == 'sm', 'modal-lg': size == 'lg','modal-full':size == 'full'}">
        <div class="modal-content" modal-transclude="">
            <div class="modal-header ng-scope">
                ...
                <h3 class="modal-title ng-binding"><i class="fa fa-flag"></i> 请选择科目班级登记考勤<!-- ngIf: vm.maxNum > 1 --></h3></div>
            <div class="modal-body ng-scope">
                ...
                grid.search_value = '';
                ">
                                        <button type="button" class="btn btn-default btn-sm ng-pristine ng-valid ng-touched" ng-model="grid.search_key" data-html="1" bs-options="item.name as item.value for item in filter.fields" bs-select="">班级名称&nbsp;<span class="caret"></span></button>
                                    </div>
