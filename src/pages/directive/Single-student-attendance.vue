            ...
            <div ng-controller="wAttendanceCtrl" class="ng-scope">
                ...
                <div class="modal-body" ng-switch="$action">
                    ...
                    <div ng-switch-when="att_by_student" class="ng-scope">
                        <div class="padder-v bg-light text-center"><a class="btn btn-default btn-xs pull-left m-l-xs" ng-click="back_menu()"><i class="fa fa-chevron-left"></i> 返回</a> <strong>按单个学员考勤</strong></div>
