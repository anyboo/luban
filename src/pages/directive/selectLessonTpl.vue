    ...
    <div class="modal-dialog" ng-class="{'modal-sm': size == 'sm', 'modal-lg': size == 'lg','modal-full':size == 'full'}">
        <div class="modal-content" modal-transclude="">
            <div class="modal-header ng-scope">
                ...
                <h3 class="modal-title ng-binding"><i class="fa fa-flag"></i> 请选择课时包<!-- ngIf: vm.maxNum > 1 --></h3></div>
                ...
                ">
                    ...
                    <ul class="list-group m-t">
                        ...
                        <div class="grid-data-result">
                            ...
                            <p class="text-center ng-binding ng-scope" ng-if="!loading &amp;&amp; grid.data.length==0"><i class="fa fa-frown-o"></i>没有符合条件的课程!</p>
            ...
            <script type="text/ng-template" id="select_lesson_tpl.ctrl.js" class="ng-scope">$scope.$on('lesson:refresh',function(){ $scope.rest_get(); $scope.refresh_gv('lessons'); });
            </script>
        </div>
    </div>
</template>
