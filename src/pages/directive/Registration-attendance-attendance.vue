        ...
        <div class="modal-content" modal-transclude="">
            <div page-controller="reg_student_attendance" class="ng-scope">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><i class="fa fa-calendar">登记学员考勤</i><span class="label bg-info ng-binding">(zzzsz)</span></h3></div>
                                    ...
                                    <div class="inline">
                                        ...
                                        <div class="btn-group pull-right m-l-xs" dropdown="">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li ng-repeat="item in time_sections_rest.$list" class="ng-scope"><a ng-click="att.teach_start_hour = item.int_start_hour;att.teach_end_hour=item.int_end_hour" class="ng-binding">士大夫 18:00 ~ 22:00</a></li>
                                                <!-- end ngRepeat: item in time_sections_rest.$list -->
                                                <li ng-repeat="item in time_sections_rest.$list" class="ng-scope"><a ng-click="att.teach_start_hour = item.int_start_hour;att.teach_end_hour=item.int_end_hour" class="ng-binding">12额 20:00 ~ 23:00</a></li>
                                                <!-- end ngRepeat: item in time_sections_rest.$list -->
                                            </ul>
                                        </div>
                                    </div>
