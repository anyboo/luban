        ...
        <div class="panel panel-default ng-scope" xo-rest="arrearages" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,ob_id:user.gv.ob_id}}" xo-rest-ctrl="arrearages">
            <div class="row wrapper">
                ...
                <div class="col-xs-12 col-md-8 m-t">
                    ...
                    <button class="btn btn-default m-l-xs ng-isolate-scope" export="arrearages" export-params="params"><i class="glyphicon glyphicon-export"></i>导出</button>
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            <td>
                                <div class="btn-group dropdown open" dropdown="">
                                    <button type="button" class="btn btn-xs btn-default" dropdown-toggle="" aria-haspopup="true" aria-expanded="true">操作 <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a ng-click="$util.open('tpl/app/student/order/pay_now.modal.html','md',item)"><i class="icon-wallet"></i> 现场缴费</a></li>
                                        <li><a ng-click="$util.open('tpl/app/student/order/pay_reg.modal.html','md',item)"><i class="icon-note"></i> 缴费登记</a></li>
                                        <li><a ng-click="$util.open('tpl/app/student/order_unpay_clear.modal.html','md',item)"><i class="icon-ban"></i> 欠费清除</a></li>
                                    </ul>
                                </div>
                            </td>
                            ...
                            <td><span class="badge bg-danger ng-binding">3000.00</span></td>
                            <td><span class="badge bg-info ng-binding">3000.00</span></td>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            <td>
                                <div class="btn-group dropdown" dropdown="">
                                    <button type="button" class="btn btn-xs btn-default" dropdown-toggle="" aria-haspopup="true" aria-expanded="false">操作 <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a ng-click="$util.open('tpl/app/student/order/pay_now.modal.html','md',item)"><i class="icon-wallet"></i> 现场缴费</a></li>
                                        <li><a ng-click="$util.open('tpl/app/student/order/pay_reg.modal.html','md',item)"><i class="icon-note"></i> 缴费登记</a></li>
                                        <li><a ng-click="$util.open('tpl/app/student/order_unpay_clear.modal.html','md',item)"><i class="icon-ban"></i> 欠费清除</a></li>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            ...
                            <td><span class="badge bg-danger ng-binding">1000.00</span></td>
                            <td><span class="badge bg-info ng-binding">3000.00</span></td>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            ...
                            <td><span class="badge bg-danger ng-binding">2000.00</span></td>
                            <td><span class="badge bg-info ng-binding">2000.00</span></td>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            ...
                            <td><span class="badge bg-danger ng-binding">40.00</span></td>
                            <td><span class="badge bg-info ng-binding">270.00</span></td>
                            <td class="ng-binding">李哥</td>
                        </tr>
                        <!-- end ngIf: !loading -->
                        <!-- end ngRepeat: item in grid.data -->
                        <tr>
                            ...
                            <td xo-data-count="grid.data" xo-data-field="unpay_amount" class="ng-isolate-scope"><span class="ng-binding">9040</span></td>
                            <td xo-data-count="grid.data" xo-data-field="order_amount" class="ng-isolate-scope"><span class="ng-binding">11270</span></td>
                            <td></td>
                        </tr>
                        <!-- ngIf: grid.$data.ctotal_unpay_amount -->
                        <tr ng-if="grid.$data.ctotal_unpay_amount" class="ng-scope">
                            <td></td>
                            <td colspan="6">本页小计:<span class="text-success ng-binding">9040元</span></td>
                        </tr>
                        <!-- end ngIf: grid.$data.ctotal_unpay_amount -->
                    </tbody>
                </table>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center"><small class="text-muted inline m-t-sm m-b-sm ng-binding" ng-bind-template="共 5 个欠费订单">共 5 个欠费订单</small>
                        <!-- ngIf: grid.$data.total_unpay_amount --><small ng-if="grid.$data.total_unpay_amount" class="ng-binding ng-scope">总金额:9040.00元</small>
                        <!-- end ngIf: grid.$data.total_unpay_amount -->
                    </div>
