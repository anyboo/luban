                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            ...
                            <td><span class="badge bg-success ng-binding">30.00</span>
                                <!-- ngIf: item.money_refund_to == '1' -->
                            </td>
                        ...
                        <tr>
                            ...
                            <td xo-data-count="grid.data" xo-data-field="amount" class="ng-isolate-scope"><span class="ng-binding">30</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
