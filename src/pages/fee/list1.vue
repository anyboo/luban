        ...
        <div class="panel panel-default ng-scope" xo-rest="pay_history" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,ob_id:user.gv.ob_id,is_pay:1}}" xo-rest-ctrl="pay_history">
            <div class="row wrapper">
                <div class="col-xs-12 col-md-4 m-t">
                    <div class="inline">
                        <input type="text" id="ctl_date_start" ng-model="params.date_start" range-picker="daterange" pp-end="#ctl_date_end" options="dateRangeOptions" class="ng-pristine ng-untouched ng-valid ng-isolate-scope" style="display: none;">
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            ...
                            <td><span class="badge bg-success ng-binding">1000.00</span>
                                <!-- ngIf: item.refund_amount > 0 -->
                            </td>
                            ...
                            <td>
                                ...
                                <div class="inline ng-scope" ng-if="item.orb_id == '0'">
                                    <!-- ngIf: item.orb_id == '0' && item.bill_no != '' -->
                                    <!-- ngIf: item.bill_no != '' -->
                                    <!-- ngIf: item.bill_no == '' --><span class="m-l-xs ng-scope" ng-if="item.bill_no == ''">收据未开</span>
                                    <!-- end ngIf: item.bill_no == '' -->
                                </div>
                                <!-- end ngIf: item.orb_id == '0' -->
                            </td>
                            <td>
                                <!-- ngIf: item.lesson_type == '0' --><span ng-if="item.lesson_type == '0'" class="ng-scope"><a class="link ng-binding" ng-click="params.oc_id=item.oc_id">[班课]3期班</a></span>
                                <!-- end ngIf: item.lesson_type == '0' -->
                                <!-- ngIf: item.lesson_type == '1' || item.lesson_type == '10' -->
                                <!-- ngIf: item.lesson_type == '2' -->
                                <!-- ngIf: item.lesson_type == '3' -->
                            </td>
                        ...
                        <tr>
                            ...
                            <td xo-data-count="grid.data" xo-data-field="amount" class="ng-isolate-scope"><span class="ng-binding">2000</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <!-- ngIf: params.oc_id || params.ol_id -->
                    </div>
                    <div class="col-sm-4 text-center"><small class="text-muted inline m-t-sm m-b-sm ng-binding" ng-bind-template="共 2 条记录">共 2 条记录</small>
                        <!-- ngIf: grid.$data.total_amount -->
                    </div>
