    ...
    <div>
        ...
        <div class="wrapper-xs ng-scope" xo-rest="contracts" xo-rest-ctrl="att_ct" xo-rest-grid="{maxsize:5,params:{pagesize:20,page:1,is_expired:0,end_time:0,ob_id:user.gv.ob_id}}" loading-text="正在加载1对1合同..." empty-text="没有符合条件的1对1合同!">
            <div class="row wrapper no-gutter bg-light">
                ...
                <div class="col-xs-10">
                    <div class="m-b-xs">
                        <select class="form-control ng-pristine ng-untouched ng-valid" name="ol_id" ui-jq="chosen" ng-model="params.ol_id" ng-options="lesson.ol_id as lesson.lesson_name for lesson in $gv.lessons|filter:{'lesson_type':'1'}" style="display: none;">
                            <option value="" class="">选择课程</option>
                            <option value="0">qq</option>
                        </select>
                        <div class="chosen-container chosen-container-single" style="width: 707px;" title=""><a class="chosen-single" tabindex="-1"><span>选择课程</span><div><b></b></div></a>
                ...
                <table class="table table-striped table-hover b-t b-light">
                    ...
                    <tbody>
                        ...
                        <tr ng-click="select_contract(item)" ng-repeat="item in grid.data" ng-if="!loading" class="ng-scope">
                            <td><span ng-bind-html="item.student.sex|sex:0" class="ng-binding"><i class="fa fa-female"></i></span> <span class="ng-binding">zzzsz</span>
                                <!-- ngIf: show_en_name --><span ng-if="show_en_name" class="ng-binding ng-scope">hh</span>
                                <!-- end ngIf: show_en_name -->
                            </td>
                            <td><span class="ng-binding">qq</span></td>
                            <td>
                                <div class="progress ng-isolate-scope" style="margin:0" max="item.lesson_times" value="item.use_times" type="info">
                                    <div class="progress-bar progress-bar-info" ng-class="type &amp;&amp; 'progress-bar-' + type" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="12" ng-style="{width: percent + '%'}" aria-valuetext="0%" ng-transclude="" style="width: 0%;"><span style="white-space:nowrap;padding-left:20px" class="ng-binding ng-scope">0 / 12</span></div>
                                </div>
                            </td>
                        </tr>
                        <!-- end ngIf: !loading -->
