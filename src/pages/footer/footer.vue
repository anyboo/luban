        ...
        <div class="modal-content" modal-transclude="">
            <div page-controller="OrderUnpayClear" class="ng-scope">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><i class="icon-ban"></i> 清除订单 <span class="label bg-info ng-binding">OB1167817130502042611809</span> 未付款</h3></div>
                    ...
                    <form name="form1" class="form-horizontal form-validation ng-pristine ng-valid ng-valid-required ng-valid-number ng-valid-parse">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-5">
                                <p class="form-control-static ng-binding">OB1167817130502042611809</p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-5">
                                <p class="form-control-static ng-binding">22</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-5">
                                <p class="form-control-static ng-binding">22元</p>
                            </div>
                        </div>
                        <div class="form-group">
