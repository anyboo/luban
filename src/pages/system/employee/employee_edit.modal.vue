<template>
    <div class="modal-dialog" ng-class="{'modal-sm': size == 'sm', 'modal-lg': size == 'lg','modal-full':size == 'full'}">
        <div class="modal-content" modal-transclude="">
            <div page-controller="employee_edit" class="ng-scope">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><i class="fa fa-user"></i> 编辑 <span class="label bg-info ng-binding">陈佳木</span> 的资料</h3></div>
                <div class="modal-body">
                    ...
                    <form name="form1" class="form-validation form-horizontal ng-valid ng-valid-required ng-valid-minlength ng-valid-parse ng-dirty">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-xs-12">
                                <div class="btn-group">
                                    <label btn-radio="'1'" ng-model="employee.sex" class="btn btn-default ng-pristine ng-untouched ng-valid"><i class="fa fa-male"></i>男</label>
                                    <label btn-radio="'2'" ng-model="employee.sex" class="btn btn-default ng-pristine ng-untouched ng-valid"><i class="fa fa-female"></i>女</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-xs-12">
                                <div class="ui-select-multiple ui-select-bootstrap dropdown form-control ng-valid ng-dirty" ng-class="{open: $select.open}" multiple="multiple" ng-model="employee.or_ids" theme="bootstrap">
                                    <div><span class="ui-select-match" placeholder="选择角色..."><!-- ngRepeat: $item in $select.selected --><span ng-repeat="$item in $select.selected" class="ng-scope"><span style="margin-right: 3px;" class="ui-select-match-item btn btn-default btn-xs" tabindex="-1" type="button" ng-disabled="$select.disabled" ng-click="$select.activeMatchIndex = $index;" ng-class="{'btn-primary':$select.activeMatchIndex === $index}"><span class="close ui-select-match-close" ng-hide="$select.disabled" ng-click="$select.removeChoice($index)">&nbsp;×</span> <span uis-transclude-append=""><span class="ng-binding ng-scope">校长</span></span>
                                        </span>
                                        </span>
                                        <!-- end ngRepeat: $item in $select.selected --><span ng-repeat="$item in $select.selected" class="ng-scope"><span style="margin-right: 3px;" class="ui-select-match-item btn btn-default btn-xs" tabindex="-1" type="button" ng-disabled="$select.disabled" ng-click="$select.activeMatchIndex = $index;" ng-class="{'btn-primary':$select.activeMatchIndex === $index}"><span class="close ui-select-match-close" ng-hide="$select.disabled" ng-click="$select.removeChoice($index)">&nbsp;×</span> <span uis-transclude-append=""><span class="ng-binding ng-scope">教师</span></span>
                                        </span>
                                        </span>
                                        <!-- end ngRepeat: $item in $select.selected --><span ng-repeat="$item in $select.selected" class="ng-scope"><span style="margin-right: 3px;" class="ui-select-match-item btn btn-default btn-xs" tabindex="-1" type="button" ng-disabled="$select.disabled" ng-click="$select.activeMatchIndex = $index;" ng-class="{'btn-primary':$select.activeMatchIndex === $index}"><span class="close ui-select-match-close" ng-hide="$select.disabled" ng-click="$select.removeChoice($index)">&nbsp;×</span> <span uis-transclude-append=""><span class="ng-binding ng-scope">前台</span></span>
                                        </span>
                                        </span>
                                        <!-- end ngRepeat: $item in $select.selected --><span ng-repeat="$item in $select.selected" class="ng-scope"><span style="margin-right: 3px;" class="ui-select-match-item btn btn-default btn-xs" tabindex="-1" type="button" ng-disabled="$select.disabled" ng-click="$select.activeMatchIndex = $index;" ng-class="{'btn-primary':$select.activeMatchIndex === $index}"><span class="close ui-select-match-close" ng-hide="$select.disabled" ng-click="$select.removeChoice($index)">&nbsp;×</span> <span uis-transclude-append=""><span class="ng-binding ng-scope">管理员</span></span>
                                        </span>
                                        </span>
                                ...
                                <!-- ngIf: user.gv.org.ft_open == '1' && is_teacher(employee) -->
                                <div class="checkbox inline m-l-xs">
                                    <label class="i-checks">
                                        <input ng-model="employee.is_sa" ng-true-value="'1'" ng-false-value="'0'" type="checkbox" value="1" class="ng-pristine ng-untouched ng-valid"> <i></i> 助教</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-xs-12">
                                <div class="ui-select-multiple ui-select-bootstrap dropdown form-control ng-valid ng-dirty" ng-class="{open: $select.open}" multiple="multiple" ng-model="employee.ob_ids" theme="bootstrap">
                                    <div><span class="ui-select-match" placeholder="选择校区..."><!-- ngRepeat: $item in $select.selected --><span ng-repeat="$item in $select.selected" class="ng-scope"><span style="margin-right: 3px;" class="ui-select-match-item btn btn-default btn-xs" tabindex="-1" type="button" ng-disabled="$select.disabled" ng-click="$select.activeMatchIndex = $index;" ng-class="{'btn-primary':$select.activeMatchIndex === $index}"><span class="close ui-select-match-close" ng-hide="$select.disabled" ng-click="$select.removeChoice($index)">&nbsp;×</span> <span uis-transclude-append=""><span class="ng-binding ng-scope">福州布尔培训 &lt;福州布尔培训&gt;</span></span>
                                        </span>
                                        </span>
                                        <!-- end ngRepeat: $item in $select.selected -->
                                        </span>
      ...
      <!-- ngRepeat: selectedItem in selectedItems --><span ng-repeat="selectedItem in selectedItems" class="selected-item btn btn-xs btn-default ng-binding ng-scope">默认分组 <span class="selected-item-close" ng-click="deselectItem(selectedItem, $event)"></span></span>
                                            <!-- end ngRepeat: selectedItem in selectedItems -->
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 col-xs-12"><i class="fa fa-phone"></i> 电话:</label>
                            <div class="col-md-10 col-xs-12">
                                <input type="text" name="tel" class="form-control ng-pristine ng-untouched ng-valid" ng-model="employee.tel">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2 col-xs-12"><i class="glyphicon glyphicon-envelope"></i> Email:</label>
                            <div class="col-md-10 col-xs-12">
