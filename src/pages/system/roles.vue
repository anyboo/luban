            ...
            <div class="col-xs-12 col-sm-5 col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <!-- ngIf: action!='edit' --><span ng-if="action!='edit'" class="ng-scope">添加角色</span>
                        <!-- end ngIf: action!='edit' -->
                        <!-- ngIf: action=='edit' -->
                        <button class="btn btn-default btn-xs pull-right ng-hide" ng-click="rest_new('role')" ng-show="action == 'edit'" ui-per="system.roles.add"><i class="fa fa-plus"></i></button>
                    </div>
                    <div class="panel-body">
                        <form name="form1" class="form-validation ng-pristine ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength" ng-init="action='add';role.og_id=user.og_id">
                            ...
                            <div class="m-t m-b">
                                <button type="submit" ng-disabled="form1.$invalid || saving || role.og_id==0" class="btn btn-primary" ng-click="rest_save('role','roles',save_callback)" disabled="disabled"><i class="fa fa-spinner fa-spin ng-hide" ng-show="saving"></i> 保存</button>
                                <!-- ngIf: role.og_id==0 -->
                            </div>
                        </form>
                    </div>
